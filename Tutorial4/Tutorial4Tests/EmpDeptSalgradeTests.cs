...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.SelectMany(e => grades, (e, g) => new { e, g }).Where(eg => eg.e.Sal >= eg.g.Losal && eg.e.Sal <= eg.g.Hisal).Select(eg => new { eg.e.EName, eg.g.Grade }).ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(group => new {DeptNo = group.Key, AvgSal = group.Average(e => e.Sal)}).ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(em => em.DeptNo == e.DeptNo).Average(em => em.Sal)).Select(e => e.EName);
